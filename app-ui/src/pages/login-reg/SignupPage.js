  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/user/register", {
        ...
        body: JSON.stringify({ name, username, email, password, age, role }),
      });
    ...
    <div>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 ">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <img className="mx-auto h-36 w-auto" src={logo} alt="Lahore-Link" />
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm ">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  type="text"
                  required
                  className="block w-full rounded-md border-0 p-2 text-accent_primary shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-accent_secondary sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  <option value="normal">Reader</option>
                </select>
              </div>
            </div>
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-accent_primary px-3 p-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-accent_secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Sign in
              </button>
            </div>
